export const boxColors = [
  "bg-red-100 border-red-200", // Box 0
  "bg-orange-100 border-orange-200", // Box 1
  "bg-yellow-100 border-yellow-200", // Box 2
  "bg-purple-100 border-purple-200", // Box 3
  "bg-white border-stone-300", // Box 4
  "bg-lime-100 border-lime-200", // Box 5
  "bg-indigo-100 border-indigo-200", // Box 6
  "bg-sky-100 border-sky-200", // Box 7
  "bg-emerald-100 border-emerald-200", // Box 8
];
